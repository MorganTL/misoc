...
class Trigger_Inserter(Module):
    def __init__(self, clk_freq):
        ...
        # Trigger jitter compensation - Section 9.3.1.1 (CXP-001-2021)
        # As trigger packet can only start transmitting in char boundary, the timing between a trigger stb and the start of packet tranmission can varies.
        # To minimize this jitter, a delay that represent the time between the trigger event and the trigger packet are coded into the packet itself.
        # So receiver can compenstate this jitter using the delay value.
